...
const GAME_CONFIG_BY_NUM_PLAYERS = {
  ...
  9: {numSpies: 3, numMisions: 5, missionTeamSizes: [3, 4, 4, 5, 5], missionMinNoVotesForFail: [1, 1, 1, 2, 1], maxMissionFails: 3},
  10: {numSpies: 4, numMisions: 5, missionTeamSizes: [3, 4, 4, 5, 5], missionMinNoVotesForFail: [1, 1, 1, 2, 1], maxMissionFails: 3},
};
